...
function ProgramView() {
    ...
    const { data: programDetail, isLoading, isError } = useProgramDetail(slug || '');
    ...
    useEffect(() => {
        if (programDetail?.segments && programDetail.segments.length > 0 && !activeSegment) {
    ...
    if (isError) {
        return <div className="flex items-center justify-center min-h-screen text-red-500">Error al cargar el programa</div>;
    }
