...
function Tabs({ program, activeSegment, setActiveSegment, showDetails, setShowDetails }: TabsProps) {
    return (
        <div className='mx-25 border-b-2 border-white/25 text-xl font-medium mt-10'>
