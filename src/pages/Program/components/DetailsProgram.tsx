...
function DetailsProgram({ programDetail }: { programDetail: Program }) {
  ...
  return (
    <div className="min-h-[calc(100vh-281px)]">
      ...
      <div className="animate-in fade-in duration-500 flex flex-row gap-20">
        ...
        <div>
          <div className="text-(--clr-primary-title)/60 text-xl tracking-wider font-medium mb-3">
            <h3 className="">Año: </h3>
            <p className="">{yearProduction}</p>
          </div>
          <div className="text-(--clr-primary-title)/60 text-xl tracking-wider font-medium">
